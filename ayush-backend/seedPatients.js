...
function seedPatients() {
  return [
    opdRecord({
      ...
      dosha: 'Vata-Pitta', agni: 'Tikshna Agni (Hyper/Pitta)', koshtha: 'Krura Koshtha (Constipated/Hard)',
    ...
    opdRecord({
      ...
      triageLevel: 'P3', triageLabel: 'Moderate',
      dosha: 'Vata Dominant', agni: 'Manda Agni (Sluggish/Kapha)', koshtha: 'Madhyama Koshtha (Balanced)',
    ...
    opdRecord({
      ...
      dosha: 'Kapha-Vata', agni: 'Sama Agni (Balanced)', koshtha: 'Madhyama Koshtha (Balanced)',
